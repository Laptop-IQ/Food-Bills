...
export default function HotelsInvoice() {
  ...
  const {
    ...
    const discount =
      parseFloat(invoice.effectiveDiscount) || 0;
  ...
  function validateInvoice() {
    ...
    if (
      ...
      newErrors.roomCharges =
        "Enter a valid room amount.";
    }
  ...
  function handlePrint() {
    ...
    /*
     * Make sure browser has completed the latest React render.
     */
    ...
    /*
     * Restore browser title after print dialog closes.
     */
    const restoreTitle = () => {
      ...
      <style>{`
        ...
        *::after {
        ...
        @media print {
          ...
          /*
           * IMPORTANT:
           * Do NOT set fixed height/overflow on body/root.
           */
          html,
          body {
            width: 100% !important;
          ...
          /*
           * Put invoice directly at page origin.
           */
          .invoice-page {
          ...
          /*
           * Hide editor explicitly as an extra safeguard.
           */
          .no-print {
          ...
          /*
           * Prevent unwanted page breaking.
           */
      ...
      <div className="min-h-screen bg-[#e9e9e9] p-6 print:bg-white print:p-0">
        ...
        <section className="no-print mx-auto mb-4 w-full max-w-[210mm] rounded-lg border border-gray-200 bg-white p-[18px] shadow-sm">
          ...
          <p className="mb-[18px] mt-[5px] text-[12px] text-gray-500">
            ...
            appear in the hotel invoice preview.
          </p>
          ...
          <section className="grid grid-cols-[1fr_1fr_1.15fr] items-start gap-x-[86px]">
            ...
            <div className="min-w-0">
              ...
              <div className="text-[11.5px] font-bold leading-[1.2] text-black">
                {invoice.addressLines.map(
                  (line, index) => (
                    <React.Fragment key={index}>
                      {line}
                      {index <
                        invoice.addressLines.length - 1 && (
                        <br />
                      )}
                    </React.Fragment>
                  )
                  ...
                  {invoice.serviceDescription.map(
                    (line, index) => (
                      <React.Fragment key={index}>
                        {line}
                        {index <
                          invoice.serviceDescription.length -
                            1 && <br />}
                      </React.Fragment>
                    )
                  )}
          ...
          <section className="mt-[13px]">
            ...
            <ol className="mt-[10px] list-decimal pl-2">
              ...
              <li className="pl-[3px] text-[10px] leading-[1.45] text-[#222]">
                Any dispute with respect to the invoice is
                to be reported back to FlyZone Travels
                within 48 hours of receipt of invoice.
              </li>

              <li className="pl-[3px] text-[10px] leading-[1.45] text-[#222]">
                QR code for B2B and SEZ category invoices
                can only be scanned using app downloaded
                from the link.
                <br />
              ...
              <li className="pl-[3px] text-[10px] leading-[1.45] text-[#222]">
                This is system generated invoice and does
